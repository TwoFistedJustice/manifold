...
*  It should record which side (if appropriate) the part goes on
*    - most suspension parts will be RH or LH. Air filters will not.

*
*  Mutable Properties - Autogenerated by Repair Issue
*   (Assumes part was previously recorded in a Service Record)
*  ----------------------------------------------------------
*  It should record the date of failure (withdrwal from service?)
